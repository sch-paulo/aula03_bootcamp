...
dados_entrada = []
resposta = input('Adicione dados (ou "sair" para parar): ')
while resposta != 'sair':
    dados_entrada.append(resposta)
    resposta = input('Adicione dados (ou "sair" para parar): ')
print(dados_entrada)
print()
...
numero = int(input(f'Insira um número dentro do intervalo ({intervalo_inferior} a {intervalo_superior}): '))
while (numero < intervalo_inferior) or (numero > intervalo_superior): 
    numero = int(input(f'Insira um número dentro do intervalo ({intervalo_inferior} a {intervalo_superior}): '))
print(numero)
print()
...
while pagina_atual <= paginas_totais:
    print(f'Você está navegando a página {pagina_atual}, avançando...')
    pagina_atual += 1
print()
...
while tentativa <= limite_tentativas:
    valor_randomico = random.randint(1,15)
    if valor_randomico == 3:
        print('Reconectado!')
        break
    else:
